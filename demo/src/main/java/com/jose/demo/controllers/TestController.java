...
public class TestController {
	...
	public String testControllerStringPo(@RequestBody String texto, @PathVariable String param) {
		return "Datos recibidos mediante POST " + texto + "parametro de URL: " + param;
